...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#D2D7D3">
    ...
    <tr>
        <td width="100%" valign="top" align="center">
            ...
            <table width="100%" data-module="Notif7.3" data-thumb="thumbnails/Notif7.3.png" align="center" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#ececec" data-bgcolor="MainBG_Color5">
                ...
                <tr>
                    <td align="center">
                        ...
                        <!-- Start Container -->
                        <table width="600" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff" class="container">
                            <tbody>
                            <tr>
            ...
            <table width="100%" data-module="Notif7.4" data-thumb="thumbnails/Notif7.4.png" align="center" cellpadding="0" cellspacing="0" border="0" class="wrapper" bgcolor="#ececec" data-bgcolor="MainBG_Color5">
                <tbody>
                <tr>
                    <td align="center">
                            ...
                            <tr>
                                ...
                                <td width="40%" align="center" class="mobile">
                                    <table width="80%" align="center" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td style="font-family: OpenSans, Arial, sans-serif; font-size: 14px; color: #8d8d8d; line-height:26px; font-weight:400;" data-color="H6wht Color" data-size="H6wht Size" data-min="10" data-max="24" mc:edit=""><multiline label="content">Features</multiline></td>
                                        </tr>
                                        <tr>
                                            <td height="10"></td>
                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td valign="top">
                                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    <tbody><tr>
                                                                        <td width="50"><img mc:edit="" editable="" src="{{$detailorder[$i]['gambar']}}" width="50" height="50"></td>
                        ...
                        <table width="600" border="0" cellspacing="0" cellpadding="0" class="container" bgcolor="#ffffff">
                            <tr>
                                <td align="center">
                                    ...
                                    <table width="600" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff" class="container">
                                        <tbody><tr>
                                            <td style="" class="mobileOn"></td>
                                            <td width="40%" align="center" valign="top" class="mobile">&nbsp;</td>
                                            <td height="10" style="" class="mobileOn"></td>
                                                                                                            ...
                                                                                                            <table width="125" cellpadding="0" cellspacing="0" align="center" border="0">
                                                                                                                <tbody><tr>
                                                                                                                    <td width="130" height="45" bgcolor="#42729B" data-bgcolor="ButonBGcolor" align="center" valign="middle" style="font-size: 14px; color: #ffffff; line-height:24px;border-radius: 4px;">
                                                                                                                        <a href="{{url('/konfirmasi-pembayaran?inv='.$invoice)}}" target="_blank" alias="" style="font-family: OpenSans, Arial, sans-serif; font-size: 13px; text-decoration:none; color: #FFFFFF; line-height:22px; font-weight:400;" data-color="H8Linkwht Color" data-size="H8Linkwht Size" data-min="8" data-max="24" mc:edit=""><multiline>Reset</multiline></a>
                                                                                                                    </td>
                                                                                                                </tr>
                                                                                                                </tbody>
                                                                                                            </table>
